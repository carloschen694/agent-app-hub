...
export function CampingMarkdownCard({ manifest, onOpen }: CardWidgetProps) {
  return (
    <Card
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-2.5">
          <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-blue-50 text-blue-600 shrink-0">
            <span className="material-symbols-outlined text-lg font-semibold">description</span>
          </div>
